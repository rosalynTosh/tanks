...
export class NetClient {
    ...
    public sendBullet(clientSideId: number, bullet: Bullet) {
        const buf = new ArrayBuffer(15);
        const dv = new DataView(buf);

        dv.setUint8(0, 'b'.charCodeAt(0));
        dv.setUint16(1, clientSideId, false);
        dv.setFloat32(3, bullet.initX, false);
        dv.setFloat32(7, bullet.initY, false);
        dv.setFloat32(11, bullet.dir, false);
